...
if __name__ == "__main__":
    ...
    n_samples, n_outliers, n_features = 2000, 100, 1
    ...
    robust_model = linear_model.HuberRegressor()
    robust_model.fit(X, y)

    print("Evaluating models...")
    print("Linear regression R2 score: {0}".format(r2_score(y_test, lr_model.predict(X_test))))
    print("Huber regression R2 score: {0}".format(r2_score(y_test, robust_model.predict(X_test))))
    ...
    plt.plot(line_X, line_y_rnc, color="fuchsia", linewidth=2, label="Huber Regression")
